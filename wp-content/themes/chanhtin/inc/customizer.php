		  ...
		  array (
			...
			array (
				...
				'type'  		=> 'text',
			 	...
			 	/*backgroud banner*/			
			// array (
			// 	'key'   		=> 'tab_bg_banner_vie',
			// 	'label' 		=> __( 'banner_vie', 'htz' ),
			// 	'name'  		=> 'tab_bg_banner_vie',
			// 	'type'  		=> 'tab',
			// 	'placement' 	=> 'left',
			// ),
			// array (
			// 	'key'   		=> 'bg_banner_vie',
			// 	'label' 		=> __( 'banner_vie detail 1920 x 1080', 'htz' ),
			// 	'name'  		=> 'bg_banner_vie',
			// 	'type'  		=> 'image',
			// ),
			...
			/*slider_en*/
     		/*gallery*/
			  array (
				...
				array (
					'key'   		=> 'banner_vie_detail',
					'label' 		=> __( 'banner_vie detail 1920 x 282', 'htz' ),
					'name'  		=> 'banner_vie_detail',
					'type'  		=> 'image',
				),
				
				array (
					'key'   		=> 'banner_vie_service',
					'label' 		=> __( 'banner_vie service 1920 x 282', 'htz' ),
					'name'  		=> 'banner_vie_service',
					'type'  		=> 'image',
				),
				array (
					'key'   		=> 'banner_vie_news',
					'label' 		=> __( 'banner_vie news 1920 x 282', 'htz' ),
					'name'  		=> 'banner_vie_news',
					'type'  		=> 'image',
				),
				array (
					'key'   		=> 'banner_vie_doc',
					'label' 		=> __( 'banner_vie document 1920 x 282', 'htz' ),
					'name'  		=> 'banner_vie_doc',
					'type'  		=> 'image',
				),
				/*end banner*/
				...
				array (
					'key'   		=> 'banner_en',
					'label' 		=> __( 'banner_en', 'htz' ),
					'name'  		=> 'banner_en',
					'type'  		=> 'tab',
					'placement' 	=> 'left',
				),
				array (
					'key'   		=> 'banner_en_detail',
					'label' 		=> __( 'banner_en detail 1920 x 282', 'htz' ),
					'name'  		=> 'banner_en_detail',
					'type'  		=> 'image',
				),
				
				array (
					'key'   		=> 'banner_en_service',
					'label' 		=> __( 'banner_en service 1920 x 282', 'htz' ),
					'name'  		=> 'banner_en_service',
					'type'  		=> 'image',
				),
				array (
					'key'   		=> 'banner_en_news',
					'label' 		=> __( 'banner_en news 1920 x 282', 'htz' ),
					'name'  		=> 'banner_en_news',
					'type'  		=> 'image',
				),
				array (
				...
				/*social_icon*/
				  array (
						'key'   		=> 'tab_social_icon',
						'label' 		=> __( 'social_icon', 'htz' ),
						'name'  		=> 'tab_social_icon',
						'type'  		=> 'tab',
						'placement' 	=> 'left',
					),
			 
					array (
					'key'   		=> 'list_social_icon',
					'label' 		=> __( 'Hình social_icon (40x40)', 'htz' ),
					'name'  		=> 'list_social_icon',
					'type'  		=> 'repeater',
					//'layout'	   => 'block',
					'layout'	   => 'table',
					'button_label' => __( 'Thêm', 'htz' ),
					'sub_fields' => array (
						array (
							'key'   		=> 'fa_social_icon',
							'label' 		=> __( 'social_icon icon', 'htz' ),
							'name'  		=> 'fa_social_icon',
							'type'  		=> 'text',
						),
						array (
							'key'   		=> 'link_social_icon',
							'label' 		=> __( 'Link', 'htz' ),
							'name'  		=> 'link_social_icon',
							'type'  		=> 'text',
